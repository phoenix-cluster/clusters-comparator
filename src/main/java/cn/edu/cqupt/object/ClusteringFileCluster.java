...
public class ClusteringFileCluster implements ICluster {
    ...
    public ClusteringFileCluster(float avPrecursorMz, float avPrecursorIntens, List<ISpectrumReference> spectrumRefs,
                                 List<Float> consensusMzValues, List<Float> consensusIntensValues, String id, String fileName) {
        ...
        for (ISpectrumReference specRef : spectrumRefs) {
            // SpecRefs now only store unqiue psms, the previous HashSet is no
            // longer necessary
