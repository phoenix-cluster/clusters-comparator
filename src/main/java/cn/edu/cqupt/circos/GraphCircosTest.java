...
public class GraphCircosTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		ClusterTableService serviceReleaseI = new ClusterTableService(
				new File("D:\\@project\\program\\coding\\java\\clusters-comparator\\testdata\\clustering\\hdp_clustering.pxd000021.0.7_4.clustering"));
		ClusterTableService serviceReleaseII = new ClusterTableService(
				new File("D:\\@project\\program\\coding\\java\\clusters-comparator\\testdata\\clustering\\cli_clustering.pxd000021.0.7_4.clustering"));
