...
public class MgfFileReader {
    /**
     * read a mgf file content and assemble it into an ArrayList<MS> object
     * @param filePath
     * @return
     */
    public static ArrayList<MS> getAllSpectra(File filePath) throws IOException{
        ArrayList<MS> msList = new ArrayList<>();
